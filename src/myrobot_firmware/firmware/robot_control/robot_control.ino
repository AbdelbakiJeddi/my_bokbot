...
#define right_encoder_phaseB A0  
...
void loop() {
  ...
  {
    right_wheel_meas_vel = ((1000/interval) * right_encoder_counter * (60.0/225.0)) * 0.10472;
    left_wheel_meas_vel = ( (1000/interval) * left_encoder_counter * (60.0/225.0)) * 0.10472;
